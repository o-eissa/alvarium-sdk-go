...
const ImageTagEnvKey = "IMAGE_TAG"
...
type Annotation struct {
	...
	ImageTag    string         `json:"imageTag,omitempty"`  //ImageTag is the hash of the source artifact tag that emitted data being annotated
...
func NewAnnotation(key string, hash HashType, host string, imageTag string, kind AnnotationType, satisfied bool) Annotation {
	return Annotation{
		Id:          NewULID(),
		Key:         key,
		Hash:        hash,
